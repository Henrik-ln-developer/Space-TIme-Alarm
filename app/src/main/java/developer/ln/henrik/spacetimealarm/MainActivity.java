...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int ZOOM_VARIABLE = 1000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alarmAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, alarmArray);
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot childSnapshot: dataSnapshot.getChildren()) {
                    SpaceTimeAlarm alarm = childSnapshot.getValue(SpaceTimeAlarm.class);
                    if(alarm != null)
                    {
                        alarmArray.add(alarm.toString());
        ...
        listView_Alarms.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Object o = listView_Alarms.getItemAtPosition(position);
        ...
        button_NewAlarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent_NewAlarm = new Intent(MainActivity.this, SpaceTimeAlarmActivity.class);
                intent_NewAlarm.putExtra(EXTRA_EDIT, false);
                startActivityForResult(intent_NewAlarm, REQUEST_CODE_ALARM);
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_ALARM) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                {
                    final SpaceTimeAlarm alarm = new SpaceTimeAlarm(caption, location_Name, location_lat, location_lng, startTime, endTime);
